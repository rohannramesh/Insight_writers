...
def generate_tables_author_content_similarity(df_authors, df_content, urls_to_show, recent_articles, 
	...
	html.Div([
        ...
        html.Div([
            ...
            ##### ADDED BC YOUTUBE MAYBE BROKEN?
            # if not urls_to_show[0]:
    ...
    if n_clicks > 0:
        if not input_value2:
            ...
            try:
                ...
                urls_to_pass = ['https://www.youtube.com/watch?v=28mT-yMoHZ8&t=6s', 
                'https://www.youtube.com/watch?v=y5yVsdHukbc&t=2s']
            elapsed = time.time() - t
            print(elapsed)
